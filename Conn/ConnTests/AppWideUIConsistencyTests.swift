...
struct AppWideUIConsistencyTests {
    ...
    func compactKeybarUsesIconActionsAndPriorityOrder() throws {
        ...
        #expect(keybar.contains("@State private var touchGlowScale: CGFloat = 0.22"))
        #expect(keybar.contains("@State private var touchGlowOpacity: CGFloat = 0"))
        ...
        #expect(keybar.contains(".opacity(touchGlowOpacity)"))
        #expect(keybar.contains(".scaleEffect(touchGlowScale)"))
